                                ...
                                const char *nv_name)
{
    ...
    if (memset_s(&rd_user_info, sizeof(rd_user_info), 0, sizeof(rd_user_info)) != EOK) {
    ...
    if (strncpy_s(rd_user_info.nv_name, sizeof(rd_user_info.nv_name), nv_name, sizeof(nv_name) - 1) != EOK) {
    ...
    const char *nv_name, const char *temp)
{
    ...
    if (memset_s(&wr_user_info, sizeof(wr_user_info), 0, sizeof(wr_user_info)) != EOK) {
        pr_err("%s memset_s fail\n", __func__);
        return -1;
    }
    ...
    if (strncpy_s(wr_user_info.nv_name, sizeof(wr_user_info.nv_name), nv_name, sizeof(nv_name) - 1) != EOK) {
        pr_err("%s strncpy_s fail\n", __func__);
        return -1;
    }
    wr_user_info.nv_name[sizeof(wr_user_info.nv_name) - 1] = '\0';
    if (memcpy_s(wr_user_info.nv_data, sizeof(wr_user_info.nv_data), temp, nv_size) != EOK) {
