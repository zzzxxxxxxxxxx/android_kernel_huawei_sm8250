...
#ifndef _DFX_HUNGTASK_USER_H
#define _DFX_HUNGTASK_USER_H

#include <linux/types.h>

#ifdef CONFIG_DFX_HUNGTASK_USER
void htuser_post_process_userlist(void);
ssize_t htuser_list_store(struct kobject *kobj, struct kobj_attribute *attr,
			  const char *buf, size_t count);
ssize_t htuser_list_show(struct kobject *kobj, struct kobj_attribute *attr,
			 char *buf);
#else
