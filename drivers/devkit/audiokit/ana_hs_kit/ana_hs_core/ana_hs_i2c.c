...
#include "../ana_hs_extern_ops/ana_hs_extern_ops.h"
...
static void ana_hs_i2c_regmap_deinit(struct ana_hs_i2c_data *data)
{
	if (!data->regmap_cfg) {
...
static int ana_hs_i2c_init_all(struct i2c_client *i2c,
	...
	const struct i2c_device_id *id)
{
	...
	ret = ana_hs_i2c_init_all(i2c, data);
	if (ret < 0) {
