...
int tcpci_timer_init(struct tcpc_device *tcpc_dev)
{
	...
	tcpc_dev->tcpci_timer_wakelock = power_wakeup_source_register(&tcpc_dev->dev, "tcpci_timer_wakelock");
...
int tcpci_timer_deinit(struct tcpc_device *tcpc_dev)
{
	...
	power_wakeup_source_unregister(tcpc_dev->tcpci_timer_wakelock);
