...
struct smb_charger {
...
#ifdef CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION
	struct wakeup_source    *plugin_wakelock;
#endif /* CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION */
...
#ifdef CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION
	struct work_struct	wait_psy_work;
#endif /* CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION */
	...
	struct delayed_work	charge_release_lock_work;
#endif /* CONFIG_HUAWEI_POWER_EMBEDDED_ISOLATION */
	...
	bool        usb_online_active;
	bool        need_wait_psy;
	bool        support_pd_to_scp;
