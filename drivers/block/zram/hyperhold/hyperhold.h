...
extern ssize_t hyperhold_enable_show(struct device *dev,
	struct device_attribute *attr, char *buf);
extern ssize_t ramturbo_enable_store(struct device *dev,
	struct device_attribute *attr, const char *buf, size_t len);
extern ssize_t ramturbo_enable_show(struct device *dev,
	struct device_attribute *attr, char *buf);
...
extern bool ramturbo_enable(void);
#endif
...
static inline ssize_t ramturbo_enable_store(struct device *dev,
	struct device_attribute *attr, const char *buf, size_t len)
{
	return len;
}
...
static inline ssize_t ramturbo_enable_show(struct device *dev,
	struct device_attribute *attr, char *buf)
{
	return 0;
}
...
static inline bool ramturbo_enable(void)
{
	return false;
}
