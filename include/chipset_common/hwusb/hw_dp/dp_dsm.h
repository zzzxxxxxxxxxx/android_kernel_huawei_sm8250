...
#if defined(CONFIG_HUAWEI_DP_DSM) && defined(CONFIG_HUAWEI_DP_SOURCE)
#ifndef DP_DSM_ENABLE
#define DP_DSM_ENABLE
#endif
#endif

#if defined CONFIG_HUAWEI_DP_QCOM
...
#ifdef DP_DEBUG_ENABLE
static inline int dp_get_pd_event_result(char *buf, int size)
{
	return 0;
}

static inline int dp_get_hotplug_result(char *buf, int size)
{
	return 0;
}

static inline int dp_get_timing_info_result(char *buf, int size)
{
	return 0;
}

static inline int dp_get_vs_pe_result(char *buf, int size)
{
	return 0;
}
#endif /* DP_DEBUG_ENABLE */
