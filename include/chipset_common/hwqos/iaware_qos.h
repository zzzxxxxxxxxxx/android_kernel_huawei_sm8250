...
enum {
	...
	SET_TASK_VIP_PRIO,
	SET_TASK_MIN_UTIL,
	SET_TASK_MIN_UCLAMP = 101,
	SET_TASK_MAX_UCLAMP = 102,
	SET_TASK_PRIORITY = 103,
	CTRL_MAX_NR,
};
...
#define CTRL_SET_TASK_MIN_UCLAMP \
	_IOW(QOS_CTRL_MAGIC, SET_TASK_MIN_UCLAMP, struct task_config)
#define CTRL_SET_TASK_MAX_UCLAMP \
	_IOW(QOS_CTRL_MAGIC, SET_TASK_MAX_UCLAMP, struct task_config)
#define CTRL_SET_TASK_PRIORITY \
	_IOW(QOS_CTRL_MAGIC, SET_TASK_PRIORITY, struct task_config)
