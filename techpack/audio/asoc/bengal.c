...
static struct snd_soc_card *populate_snd_card_dailinks(struct device *dev)
{
	...
	smartpa_type_enum = hw_get_smartpa_type();
	pr_info("%s smartpa type =%d",__func__, smartpa_type_enum);

	if (smartpa_type_enum == CS35LXX) {
		msm_mi2s_be_dai_links[0].codec_name ="cs35l36.0-0050";
		msm_mi2s_be_dai_links[0].codec_dai_name = "cs35l36-pcm";
		msm_mi2s_be_dai_links[1].codec_name ="cs35l36.0-0050";
		msm_mi2s_be_dai_links[1].codec_dai_name = "cs35l36-pcm";
	} else if (smartpa_type_enum == AW882XX) {
		msm_mi2s_be_dai_links[0].codec_name ="aw882xx_smartpa";
		msm_mi2s_be_dai_links[0].codec_dai_name = "aw882xx-aif";
		msm_mi2s_be_dai_links[1].codec_name ="aw882xx_smartpa";
		msm_mi2s_be_dai_links[1].codec_dai_name = "aw882xx-aif";
	} else if (smartpa_type_enum == TFA98XX) {
		msm_mi2s_be_dai_links[0].codec_name ="tfa98xx.0-0034";
		msm_mi2s_be_dai_links[0].codec_dai_name = "tfa98xx-aif-0-34";
		msm_mi2s_be_dai_links[1].codec_name ="tfa98xx.0-0034";
		msm_mi2s_be_dai_links[1].codec_dai_name = "tfa98xx-aif-0-34";
	}
