...
static int mas_bkops_print_dur_unistore(
	char *buf, size_t len, const struct bkops_stats *bkops_stats)
{
	int offset = 0;
	...
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work start in idle: %u\n",
		bkops_stats->bkops_fs_work_start_idle_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work start not in idle: %u\n",
		bkops_stats->bkops_fs_work_start_not_idle_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work start already start: %u\n",
		bkops_stats->bkops_fs_work_start_already_start_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work start no need start: %u\n",
		bkops_stats->bkops_fs_work_start_no_need_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work query: %u\n",
		bkops_stats->bkops_fs_work_query_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work query not idle: %u\n",
		bkops_stats->bkops_fs_work_query_not_idle_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work query already start: %u\n",
		bkops_stats->bkops_fs_work_query_already_start_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work query no need start: %u\n",
		bkops_stats->bkops_fs_work_query_no_need_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work stop not start: %u\n",
		bkops_stats->bkops_fs_work_stop_not_start_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work stop : %u\n",
		bkops_stats->bkops_fs_work_stop_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops idle in fs work start: %u\n",
		bkops_stats->bkops_idle_fs_work_start_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops idle not in fs work start: %u\n",
		bkops_stats->bkops_idle_fs_work_not_start_count);
	offset += snprintf(buf + offset, len - offset,
		"bkops fs work end: %u\n",
		bkops_stats->bkops_fs_work_end_count);
...
#ifdef CONFIG_MAS_UNISTORE_PRESERVE
	offset += mas_bkops_print_dur_unistore(
		buf + offset, len - offset, bkops_stats);
#endif
	return offset;
}
