...
struct adsp_misc_ex_common_info {
	unsigned int      param_size;
...
#define ADSP_MISC_IOCTL_VOICE_MSG \
	_IOW('A', 0x4, struct misc_io_sync_param) // AP send voice msg to ADSP
...
#define ADSP_MISC_IOCTL_VOICE_MSG_COMPAT \
	_IOW('A', 0x4, struct misc_io_sync_param_compat) // AP send voice msg to ADSP
